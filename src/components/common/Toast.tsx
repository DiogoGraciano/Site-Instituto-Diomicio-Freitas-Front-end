...
const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`fixed top-4 right-4 z-50 max-w-sm w-full p-4 border rounded-lg shadow-lg transition-all duration-300 ease-in-out transform ${
    ...
    >
      <div className="flex">
        ...
        <button
          ...
          className={`ml-auto ${getCloseButtonColor()} transition-colors`}
        >
